    ...
    request_body = {
        ...
        "customer": {
            ...
            "identifiers": [
                ...
                {"identifier_type": "IDENTIFIER_TYPE_USERNAME", "identifier": identifiers_type_username},
...
def update_parameter_value(
    ...
    request_body = {
        ...
        "update_mask": {"paths": paths},
        "is_cancelled_update_options": {"skip_pre_parameter_change_hook": skip_pre_parameter_change_hook},
...
def update_postings_apiclient(
    ...
    request_body = {
        ...
        "postings_api_client": {
            "client_id": client_id,
            "response_topic": response_topic or "integration.postings_api.domestic_payment_processor_id.response",
            "response_topic_low_priority": response_topic_low_priority or "integration.postings_api.domestic_payment_processor_id.low_priority.response",
        },
