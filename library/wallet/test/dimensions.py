...
PENDING_OUT_DIMENSIONS = BalanceDimensions(denomination=TEST_DENOMINATION, phase="POSTING_PHASE_PENDING_OUTGOING")
TODAYS_SPENDING_DIMENSIONS = BalanceDimensions(address=wallet.TODAYS_SPENDING, denomination=TEST_DENOMINATION)
