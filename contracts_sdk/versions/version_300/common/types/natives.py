...
calendarObject = types_utils.NativeObjectSpec(
    ...
    object=calendar,
    package=calendar,
    description=("Note: `calendar` module `HTMLCalendar.formatyearpage` method is not available."),
)
...
jsonDumpsObject = types_utils.NativeObjectSpec(name="json_dumps", object=json.dumps, package=json)

jsonLoadsObject = types_utils.NativeObjectSpec(name="json_loads", object=json.loads, package=json)
