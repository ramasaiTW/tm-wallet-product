...
class Parameter(parameters310.Parameter):
    ...
    def _validate_attributes(**kwargs):
        ...
        if not optional and isinstance(default_value, parameters310.OptionalValue):
            raise exceptions.InvalidSmartContractError(f"Non optional shapes must have a non optional default value: {name}")
