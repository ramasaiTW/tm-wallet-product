...
class SentinelAccountNotificationDirective(SentinelBase, AccountNotificationDirective):
    def __init__(self, instance_id: str):
        attr_dict = {attr.name: getattr(sentinel, f"{attr.name}_{instance_id}") for attr in self.__class__._public_attributes()}
...
class SentinelCustomInstruction(SentinelBase, CustomInstruction):
    def __init__(self, instance_id: str):
        attr_dict = {attr.name: getattr(sentinel, f"{attr.name}_{instance_id}") for attr in self.__class__._constructor_args()}
